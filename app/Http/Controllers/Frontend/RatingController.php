...
class RatingController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        if ($product_check) {
            ...
            $verified_purchase = Order::where('orders.user_id', Auth::id())->join('orders_items', 'order_id', 'orders_items.order_id')->where('orders_items.prod_id', $product_id)->get();
            ...
            return redirect()->back()->with('status', "You cant rate");
        }
    }
}
